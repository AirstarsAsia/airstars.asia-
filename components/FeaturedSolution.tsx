        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-12 flex items-center justify-center">
                <img
                  src="/images/Horizontal-Dark.png"
                  alt="FreshPass - Secure WiFi Guest Access"
